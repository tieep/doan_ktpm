...
public void thaotacPN(String hanhdong, hanhdongGUI itemClicked) throws SQLException {
        ...
        case "Thêm": {
                ...
                // Nếu chưa tồn tại, tạo mới frame_them_phieunhap
...
//                addFrame.setVisible(true);
        ...
        case "Sửa": {
            ...
            if (!selectedListPN.isEmpty()) {
                String selectedMAPN = selectedListPN.get(0); // Assuming single selection
                if (selectedMAPN != null) {
                    // Retrieve the corresponding phieunhap_DTO by MAPN
